...
### "Filtering Attention Heads through <br> Automable Interpretability Experiments"

#### Amiri Hayes, Jacob Andreas, Belinda Li

# — ADDITIONAL INFO —

[**Abstract**](https://drive.google.com/file/d/1Py0Iy6DFwMWoviuffSzoH2f0pfzIuhy6/view?usp=sharing)  [**Poster**](https://drive.google.com/file/d/1pJabwGFm6aaWH20wK8qmOcMiKy29-IiG/view?usp=sharing)  [**GitHub**](https://github.com/AmiriHayes/LLM-Interpretability)
...
&emsp; *Expand on currently implemented automated (LLM-generated) programs*
  ...
  2. Then, run the following pipeline to augment database & improve LLM programs
      ...
      - Add program to the databse and rerun cycle
\
\
